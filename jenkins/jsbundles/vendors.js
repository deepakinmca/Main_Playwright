...
/* harmony export */   U: function() { return /* binding */ popperGenerator; }
/* harmony export */ });
...
if (/^(524|608)$/.test(__webpack_require__.j)) {
	/* harmony import */ var _dom_utils_instanceOf_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5581);
}
...
var DEFAULT_OPTIONS = (/* runtime-dependent pure expression or super */ /^(524|608)$/.test(__webpack_require__.j) ? ({
  placement: 'bottom',
  modifiers: [],
  strategy: 'absolute'
}) : null);
  ...
  return function createPopper(reference, popper, options) {
    ...
    var instance = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        state.scrollParents = {
          reference: (0,_dom_utils_instanceOf_js__WEBPACK_IMPORTED_MODULE_8__/* .isElement */ .vq)(reference) ? (0,_dom_utils_listScrollParents_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(reference) : reference.contextElement ? (0,_dom_utils_listScrollParents_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(reference.contextElement) : [],
...
var left = 'left';
var auto = 'auto';
var basePlacements = (/* runtime-dependent pure expression or super */ /^(524|608)$/.test(__webpack_require__.j) ? ([top, bottom, right, left]) : null);
var start = 'start';
var end = 'end';
...
var modifierPhases = (/* runtime-dependent pure expression or super */ /^(524|608)$/.test(__webpack_require__.j) ? ([beforeRead, read, afterRead, beforeMain, main, afterMain, beforeWrite, write, afterWrite]) : null);
...
/* harmony default export */ __webpack_exports__.A = ((/* runtime-dependent pure expression or super */ /^(524|608)$/.test(__webpack_require__.j) ? ({
  name: 'applyStyles',
  enabled: true,
  phase: 'write',
  fn: applyStyles,
...
var unsetSides = (/* runtime-dependent pure expression or super */ /^(524|608)$/.test(__webpack_require__.j) ? ({
  top: 'auto',
  right: 'auto',
  bottom: 'auto',
  left: 'auto'
}) : null); // Round the offsets to the nearest suitable subpixel based on the DPR.
...
function mapToStyles(_ref2) {
  ...
  var _ref4 = roundOffsets === true ? roundOffsetsByDPR({
    x: x,
    y: y
  }, (0,_dom_utils_getWindow_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(popper)) : {
    x: x,
    y: y
  };
...
var passive = (/* runtime-dependent pure expression or super */ /^(524|608)$/.test(__webpack_require__.j) ? ({
  passive: true
}) : null);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: function() { return /* binding */ computeAutoPlacement; }
/* harmony export */ });
if (/^(524|608)$/.test(__webpack_require__.j)) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: function() { return /* binding */ getAltAxis; }
/* harmony export */ });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: function() { return /* binding */ getOppositePlacement; }
/* harmony export */ });
var hash = (/* runtime-dependent pure expression or super */ /^(524|608)$/.test(__webpack_require__.j) ? ({
  left: 'right',
  right: 'left',
  bottom: 'top',
  top: 'bottom'
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: function() { return /* binding */ getOppositeVariationPlacement; }
/* harmony export */ });
var hash = (/* runtime-dependent pure expression or super */ /^(524|608)$/.test(__webpack_require__.j) ? ({
  start: 'end',
  end: 'start'
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   P: function() { return /* binding */ withinMaxClamp; },
...
var OnSpill = (/* unused pure expression or super */ null && ([Remove, Revert]));
...
var createPopper = __webpack_require__(3424);
...
// EXTERNAL MODULE: ./node_modules/@popperjs/core/lib/modifiers/flip.js
var flip = __webpack_require__(958);
// EXTERNAL MODULE: ./node_modules/@popperjs/core/lib/modifiers/preventOverflow.js
var preventOverflow = __webpack_require__(2089);
...
var defaultModifiers = [eventListeners/* default */.A, popperOffsets/* default */.A, computeStyles/* default */.A, applyStyles/* default */.A, offset/* default */.A, flip/* default */.A, preventOverflow/* default */.A, arrow/* default */.A, hide/* default */.A];
var popper_createPopper = /*#__PURE__*/(0,createPopper/* popperGenerator */.U)({
...
var applyStylesModifier = Object.assign({}, applyStyles/* default */.A, {
